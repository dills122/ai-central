...
Options:
  ...
  --profiles LIST          Comma-separated steering profiles: base,javascript-typescript,angular,dotnet-csharp,dotnet-clean-architecture,dotnet-aspnetcore,dotnet-efcore,dotnet-orleans,dotnet-aspire,dotnet-opentelemetry,dotnet-grpc,kotlin-jvm,rust,shell-scripting,payload,frontend-design,infrastructure-opentofu
